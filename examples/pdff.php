...
//get invoices data
$query = mysqli_query($con,"select * from tentants");
...
$pdf->Cell(40, 10, 'property',1,0,'C');
$pdf->Cell(40, 10, 'reg_date',1,0,'C');
...
$pdf->Cell(20, 10, $invoice['tent_id'],1,0,'C');
$pdf->Cell(20, 10, $invoice['name'],1,0,'C');
$pdf->Cell(20, 10, $invoice['gender'],1,0,'C');
$pdf->Cell(30, 10, $invoice['phone'],1,0,'C');
$pdf->Cell(40, 10, $invoice['property'],1,0,'C');
$pdf->Cell(40, 10, $invoice['reg_date'],1,0,'C');
